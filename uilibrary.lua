...
local library = utility.table({theme = table.clone(themes.bliss), folder = "bliss V2", extension = "cfg", flags = {}, open = false, keybind = Enum.KeyCode.RightShift, mousestate = services.InputService.MouseIconEnabled, cursor = nil, holder = nil, connections = {}}, true)
...
function library:GetThemes()
	local themes = {"Default", "Midnight", "bliss"}
...
function library:Load(options)
	...
	local theme = options.theme and options.theme or "bliss"
